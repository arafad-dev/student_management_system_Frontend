...
const Student = () => {
    ...
    const studentFilter = data.filter(student => {
            ...
            <div>
                ...
                <div className="bg-white rounded-xl shadow-lg p-6">
                    <div className="flex justify-between items-center mb-6">
                        ...
                        <p className="text-gray-500">Total: {rows.length} students</p>
                    </div>
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full">
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                {rows.map((student, ind) => (
                                    <tr key={student._id} className="hover:bg-gray-50">
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="font-medium text-gray-900">{ind + 1}</div>
                                        </td>
                                        <td className="px-6 py-4 whitespace-nowrap text-gray-500">{student.name}</td>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-gray-500">{student.age}</td>
                                        <td className="px-6 py-4 whitespace-nowrap text-gray-500">{student.gender}</td>
                                        <td className="px-6 py-4 whitespace-nowrap text-gray-500">{student.address}</td>
                                        <td className="px-6 py-4 whitespace-nowrap text-gray-500">{student.course.name}</td>
                                        <td className="px-6 py-4 whitespace-nowrap">
